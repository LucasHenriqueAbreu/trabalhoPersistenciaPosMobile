...
import com.example.trabablho3.SQLite.Todo;
...
public class MyAdapterSQLite extends RecyclerView.Adapter<MyAdapterSQLite.ViewHolder> {
    private List<Todo> mDataset;

    public MyAdapterSQLite(){
    ...
    public MyAdapterSQLite(List<Todo> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public MyAdapterSQLite.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
